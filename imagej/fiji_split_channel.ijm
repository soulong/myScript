...
inputDir = "C:/Users/haohe/Desktop/Mito analysis from Qian/20250523 mito HIS-SIM/raw/";
outputDir = "C:/Users/haohe/Desktop/Mito analysis from Qian/20250523 mito HIS-SIM/green/";
...
for (i = 0; i < imageFiles.length; i++) {
    ...
    if (isRGB) {
        ...
        channelNames = newArray(baseName + image_suffix +  " (red)", baseName + image_suffix + " (green)", baseName + image_suffix + " (blue)");
