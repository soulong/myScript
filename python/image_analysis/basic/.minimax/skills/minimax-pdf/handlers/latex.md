...
**Must** use `.minimax/skills/minimax-pdf/scripts/compile_latex.py` script to compile. The script will automatically:
...
```bash
# Single compilation
python3 .minimax/skills/minimax-pdf/scripts/compile_latex.py main.tex

# Multiple runs (for cross-references and bibliography)
python3 .minimax/skills/minimax-pdf/scripts/compile_latex.py main.tex --runs 2

# Keep full logs (for debugging)
python3 .minimax/skills/minimax-pdf/scripts/compile_latex.py main.tex --keep-logs
```
...
python3 .minimax/skills/minimax-pdf/scripts/compile_latex.py main.tex --runs 3
```
