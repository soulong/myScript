...
def fit_basic_models(
    ...
    for chan in valid_channels:
        ...
        model = _basic_fit(paths, n_image, enable_darkfield, working_size, logger)
        if model is None:
            success = False
            continue
...
def main():
    ...
    parser.add_argument("root_dir", type=str, help="Root folder containing Measurement directories")
    ...
    parser.add_argument("--darkfield", action="store_true", help="Disable darkfield estimation")
    ...
    for mdir in measurements:
        ...
        try:
            ...
            if args.mode == "fit":
                ...
                apply_basic_correction(dataset, args.channels, output_dir, logger)
