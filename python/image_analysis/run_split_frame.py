...
def main():
    ...
    parser.add_argument("--tile_width", type=int, default=1024, help="Tile width in pixels")
    parser.add_argument("--tile_height", type=int, default=1024, help="Tile height in pixels")
    parser.add_argument("--delete_originals", action="store_true", help="Delete original full images after successful tiling")
    ...
    if args.tile_width <= 0 or args.tile_height <= 0:
        print("Error: tile_width and tile_height must be positive integers")
        return
