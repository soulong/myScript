...
def main() -> None:
    parser = argparse.ArgumentParser(description="Cellpose‑SAM segmentation for multiple *_Measurement X folders",
                                     formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument("root_dir", type=str, help="Root folder containing *_Measurement X sub‑folders")
    # Channel groups (group‑1 is mandatory, group‑2 optional)
    parser.add_argument("--chan1", nargs="+", type=str, default=["ch1"], required=True, help="First channel group (C1). At least one channel required.")
    ...
    for mdir in measurements:
        ...
        try:
            ...
            final_kwargs = {"remove_na_row":True, "image_subdir":"Images", "image_suffix":".tiff", **user_dataset_kwargs}
