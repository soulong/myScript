...
def main() -> None:
    ...
    parser.add_argument("--cp_project", type=str, required=True, help="Path to CellProfiler pipeline (.cppipe or .cpproj)")
    parser.add_argument("--cp_exec", type=str, default="/home/haohe/miniforge3/envs/cellprofiler/bin/cellprofiler", help="Path to CellProfiler executable")
